...
public class Section_Word
{
	 ...
	 * @param _shown 
	 */
	public Section_Word(int _position, List<Word> _files, String _value, boolean _shown) {
	 ...
	 */
	public void setM_files(List<Word> m_files) {
